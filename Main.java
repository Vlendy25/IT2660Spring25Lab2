...
class Lab2 {
  public void linkedList() {
   ...
   progLanguages.add("Java");
    ...
    languages.add(2, "HTML");// Fixed:changed 'langed 'langauges'to'progLanguages'
  ...
  public void queue() {
    ...
    System.out.println("Elements of queue: " + q);
    // 9. Remove the head of the queue and assign it to a String variable removedElement.//or q.poll() to avoid exception if the queue is empty
  ...
  public void stack() {
    ...
    // 15. Use the peek() method to view the top book on the stack
           topBook = bookStack.peek();// Fixed: removed redeclaration of 'topBook'        
           System.out.println("Top book: " + topBook);

    // 16. push() "Web DB Technologies" onto the stack
           bookStack.push("Web DB Technologies");

     // 17. Use the peek() method to view the top book on the stack //Fixed: removed redeclaration of 'topBook'          
